...
class DocumentEmbedding:
    ...
    def query(self, query_text:str, topK=5):
        if self.redis is not None:
            ...
            chain = load_qa_with_sources_chain(AzureOpenAI(temperature=1, deployment_name=self.summerization_deployment_name), \
    ...
    def load_documents(self, source_folder: str, use_redis:bool=True, verbose:bool=True):
        ...
        # json_file = re.sub(r"\.pdf", ".json", file_name, flags=re.IGNORECASE)
